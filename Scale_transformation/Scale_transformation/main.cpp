...
int main()
{
    ...
    while (!glfwWindowShouldClose(mainWindow))
    {
        ...
        model = glm::scale(model,glm::vec3(curSize,0.4f,1.0f)); //this allows us to scale the images pragmatically and not in the shader components always use the scale first before other transformations
